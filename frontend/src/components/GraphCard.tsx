...
function GraphCardBase({
  ...
  if (isGrid) {
    ...
    return (
      <div
        className={`overflow-hidden stg-inset-bare border-l-4 ${accentColor} p-4 transition-all duration-300 ${hasChart ? 'min-h-[166px]' : 'min-h-[88px]'} h-full flex flex-col`}
      >
  ...
  return (
    <div
      className={`relative overflow-hidden stg-inset-bare p-4 border-l-8 ${accentColor} min-h-[84px] transition-all duration-300`}
    >
