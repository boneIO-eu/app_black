        ...
        <div className="card-body">
          <h3 className="text-lg card-title">
            ...
            {runtime && runtimeInverted && (
              <span className="gap-1 badge badge-warning badge-sm">
                ⚡ {t('mcp.active_low')}
              </span>
            )}
          </h3>
          ...
          <div className="mt-4 form-control">
            <label className="label">
              <span className="font-medium label-text">{t('mcp.address')}</span>
            </label>
            <select
          ...
          <div className="mt-2 form-control">
            <FormInputToggle
              label={t('mcp.inverted')}
              description={t('mcp.inverted_hint')}
              checked={entry.inverted === true}
              onChange={(checked) => updateEntry(entry.id, 'inverted', checked)}
              variant="card"
