...
export const MODBUS_DEVICE_CATALOG: Record<string, ModbusDeviceInfo> = {
  "le-03mw": {
    ...
    "descriptionPl": "3-fazowy licznik energii F&F LE-03MW",
  ...
  "le-03mwct": {
    ...
    "descriptionPl": "3-fazowy licznik energii z przekładnikami F&F LE-03MW CT",
    "category": "energy_meters",
    "defaultAddress": 1,
    "defaultUpdateInterval": "10s",
    "hasSetBase": false
  ...
  "orno-or-we-517": {
    ...
    "descriptionPl": "3-fazowy licznik energii ORNO OR-WE-517",
    "category": "energy_meters",
    "defaultAddress": 1,
    "defaultUpdateInterval": "10s",
    "hasSetBase": false
  ...
  "sdm120": {
    ...
    "descriptionPl": "1-fazowy licznik energii Eastron SDM120",
    "category": "energy_meters",
    "defaultAddress": 1,
    "defaultUpdateInterval": "10s",
    "hasSetBase": false
  ...
  "sdm630": {
    ...
    "descriptionPl": "3-fazowy licznik energii Eastron SDM630",
    "category": "energy_meters",
    "defaultAddress": 1,
    "defaultUpdateInterval": "10s",
    "hasSetBase": false
  ...
  "socomec_e03": {
    ...
    "descriptionPl": "Licznik energii Socomec Countis E03",
    "category": "energy_meters",
    "defaultAddress": 1,
    "defaultUpdateInterval": "10s",
    "hasSetBase": false
  ...
  "socomec_e23": {
    ...
    "descriptionPl": "Licznik energii Socomec Countis E23",
    "category": "energy_meters",
    "defaultAddress": 1,
    "defaultUpdateInterval": "10s",
    "hasSetBase": false
  ...
  "eht-topventil-plus": {
    ...
    "descriptionPl": "Wentylacja EHT Topventil Plus",
    "category": "hvac",
    "defaultAddress": 1,
  ...
  "fujitsu-ac": {
    ...
    "descriptionPl": "Sterowanie klimatyzacją Fujitsu",
    "category": "hvac",
    "defaultAddress": 1,
    "defaultUpdateInterval": "30s",
    "hasSetBase": false
  ...
  "thessla": {
    ...
    "descriptionPl": "Rekuperator Thessla Green",
    "category": "hvac",
    "defaultAddress": 1,
    "defaultUpdateInterval": "30s",
    "hasSetBase": false
  ...
  "ventclear": {
    ...
    "descriptionPl": "Wentylacja Ventclear",
    "category": "hvac",
    "defaultAddress": 1,
    "defaultUpdateInterval": "30s",
    "hasSetBase": false
  ...
  "wanas415": {
    ...
    "descriptionPl": "Rekuperator Wanas",
    "category": "hvac",
    "defaultAddress": 1,
    "defaultUpdateInterval": "30s",
    "hasSetBase": false
  ...
  "sofar": {
    ...
    "descriptionPl": "Falownik fotowoltaiczny Sofar Solar",
    "category": "inverters",
    "defaultAddress": 1,
    "defaultUpdateInterval": "30s",
    "hasSetBase": false
  ...
  "esp32_relay_x4_modbus": {
    ...
    "descriptionPl": "4-kanałowa płytka przekaźnikowa Modbus ESP32 boneIO",
    "category": "other",
    "defaultAddress": 1,
    "defaultUpdateInterval": "30s",
    "hasSetBase": false
  ...
  "n4dsc08": {
    ...
    "descriptionPl": "8-kanałowy sterownik przekaźników Modbus N4DSC08",
    "category": "other",
    "defaultAddress": 1,
    "defaultUpdateInterval": "30s",
    "hasSetBase": true
  ...
  "r4dcb08": {
    ...
    "descriptionPl": "8-kanałowy sterownik przekaźników Modbus R4DCB08",
    "category": "other",
    "defaultAddress": 1,
    "defaultUpdateInterval": "30s",
    "hasSetBase": true
  ...
  "boneio-edge-temp": {
    ...
    "descriptionPl": "Rozszerzenie czujników temperatury boneIO Edge Temp",
    "category": "sensors",
    "defaultAddress": 1,
    "defaultUpdateInterval": "10s",
    "hasSetBase": true
  ...
  "cwt": {
    ...
    "descriptionPl": "Czujnik wilgotności, temperatury i zasolenia gleby CWT",
    "category": "sensors",
    "defaultAddress": 1,
    "defaultUpdateInterval": "30s",
    "hasSetBase": true
  ...
  "dts1964_3f": {
    ...
    "descriptionPl": "3-fazowy licznik energii i mocy DTS1964",
    "category": "sensors",
    "defaultAddress": 1,
    "defaultUpdateInterval": "10s",
    "hasSetBase": false
  ...
  "dyp-a12-ultrasonic": {
    ...
    "descriptionPl": "Ultradźwiękowy czujnik odległości/poziomu DYP-A12",
    "category": "sensors",
    "defaultAddress": 1,
    "defaultUpdateInterval": "10s",
    "hasSetBase": true
  ...
  "gdfs": {
    ...
    "descriptionPl": "Przepływomierz serii GD (GDFS)",
    "category": "sensors",
    "defaultAddress": 1,
    "defaultUpdateInterval": "10s",
    "hasSetBase": true
  ...
  "gdfx": {
    ...
    "descriptionPl": "Przepływomierz serii GD (GDFX)",
    "category": "sensors",
    "defaultAddress": 1,
    "defaultUpdateInterval": "10s",
    "hasSetBase": true
  ...
  "liquid-sensor": {
    ...
    "descriptionPl": "Uniwersalny czujnik poziomu cieczy Modbus",
    "category": "sensors",
    "defaultAddress": 1,
    "defaultUpdateInterval": "10s",
    "hasSetBase": true
  ...
  "pt100": {
    ...
    "descriptionPl": "Przetwornik temperatury PT100 na Modbus",
    "category": "sensors",
    "defaultAddress": 1,
    "defaultUpdateInterval": "10s",
    "hasSetBase": false
  ...
  "sht20": {
    ...
    "descriptionPl": "Czujnik temperatury i wilgotności SHT20",
    "category": "sensors",
    "defaultAddress": 1,
    "defaultUpdateInterval": "10s",
    "hasSetBase": true
  ...
  "sht30": {
    ...
    "descriptionPl": "Czujnik temperatury i wilgotności SHT30",
    "category": "sensors",
    "defaultAddress": 1,
    "defaultUpdateInterval": "10s",
    "hasSetBase": true
