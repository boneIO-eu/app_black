...
from boneio.const import DOUBLE, LONG, PRESSED, RELEASED, SINGLE
...
class MultiClickDetector:
    ...
    def handle_event(self, event: gpiod.EdgeEvent) -> None:
        ...
        if event.event_type is event.Type.FALLING_EDGE:
            ...
            # Cancel long-press timer if scheduled
            ...
            # Schedule finalizer to conclude thes multi-click sequence
            scheduled_at = self._loop.time()
